...
public class MoveOutSecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     //   twelveMovein.setTextColor(StaticData.getXmlParsedData().getColorSkin().getColor5());
        ...
        livingRoomOut.setBackgroundColor(StaticData.getXmlParsedData().getColorSkin().getColor5());
        ...
        diningRoomOut.setBackgroundColor(StaticData.getXmlParsedData().getColorSkin().getColor5());
        ...
        hallwayOut.setBackgroundColor(StaticData.getXmlParsedData().getColorSkin().getColor5());
        ...
        kitchenOut.setBackgroundColor(StaticData.getXmlParsedData().getColorSkin().getColor5());
